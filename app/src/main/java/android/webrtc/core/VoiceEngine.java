...
public class VoiceEngine {
  ...
  public native int setMicrophoneMute(int channel, boolean enable);

  //zhangdoudou
  public native int startRecordingMicrophone(String filename);
  ...
  private native int SetRTCPStatus(int channel, boolean enable);

  public int SetVoiceRTCPEnable(int channel, boolean enable){
    return SetRTCPStatus(channel, enable);
  }
}