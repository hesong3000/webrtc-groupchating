...
public class VideoEngine {
  ...
  public native int disconnectAudioChannel(int videoChannel);
  ...
  private native int setRTCPStatus(int channel, int rtcp_mode);
  public int SetVideoRTCPMode(int channel,int rtcpMode){
    return setRTCPStatus(channel,rtcpMode);
  }
}
